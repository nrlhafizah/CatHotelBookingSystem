...
-->
    ...
    <link rel="stylesheet" type="text/css" href="adminnew/assets/css/bootstrap.min.css">

    <link rel="stylesheet" type="text/css" href="adminnew/assets/css/font-awesome.css">

    <link rel="stylesheet" href="adminnew/assets/css/templatemo-breezed.css">

    <link rel="stylesheet" href="adminnew/assets/css/owl-carousel.css">

    <link rel="stylesheet" href="adminnew/assets/css/lightbox.css">
    ...
    <div class="main-banner header-text" id="top">
        <div class="Modern-Slider">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="adminnew/assets/images/slide-01.jpg" alt="">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="adminnew/assets/images/slide-02.jpg" alt="">
                <div class="text-content">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="adminnew/assets/images/slide-03.jpg" alt="">
                <div class="text-content">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="service-item">
                                    <img src="adminnew/assets/images/service-item-01.png" alt="">
                                    <h4>Top Notch</h4>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="service-item">
                                    <img src="adminnew/assets/images/contact-info-03.png" alt="">
                                    <h4>Reliable</h4>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <div class="features-item">
                        <div class="features-icon">
                            <img src="adminnew/assets/images/features-icon-1.png" alt="">
                        </div>
                ...
                <div class="filters-content">
                    <div class="row grid">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all des">
                          <div class="item">
                            <a href="adminnew/assets/images/project-big-item-01.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-01.jpg" alt=""></a>
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all dev">
                          <div class="item">
                            <a href="adminnew/assets/images/project-big-item-02.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-02.jpg" alt=""></a>
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all gra">
                          <div class="item">
                            <a href="adminnew/assets/images/project-big-item-03.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-03.jpg" alt=""></a>
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all tsh">
                          <div class="item">
                            <a href="adminnew/assets/images/project-big-item-04.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-04.jpg" alt=""></a>
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all dev">
                          <div class="item">
                            <a href="adminnew/assets/images/project-big-item-05.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-05.jpg" alt=""></a>
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all des">
                          <div class="item">
                            <a href="adminnew/assets/images/project-big-item-06.jpg" data-lightbox="image-1" data-title="Our Projects"><img src="assets/images/project-item-06.jpg" alt=""></a>
                          </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="adminnew/assets/images/member-item-01.jpg" alt="">
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="adminnew/assets/images/member-item-04.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="adminnew/assets/images/member-item-02.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="adminnew/assets/images/member-item-05.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="adminnew/assets/images/member-item-03.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <div class="item author-item">
                            <div class="member-thumb">
                                <img src="adminnew/assets/images/member-item-06.jpg" alt="">
                                <div class="hover-effect">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-lg-4 col-md-4 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <ul class="contact-info">
                            <li><img src="adminnew/assets/images/contact-info-01.png" alt="">010-020-0860</li>
                            <li><img src="adminnew/assets/images/contact-info-02.png" alt="">info@company.com</li>
                            <li><img src="adminnew/assets/images/contact-info-03.png" alt="">www.company.com</li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- Bootstrap -->
    <script src="adminnew/assets/js/popper.js"></script>
    <script src="adminnew/assets/js/bootstrap.min.js"></script>

    <!-- Plugins -->
    <script src="adminnew/assets/js/owl-carousel.js"></script>
    <script src="adminnew/assets/js/scrollreveal.min.js"></script>
    <script src="adminnew/assets/js/waypoints.min.js"></script>
    <script src="adminnew/assets/js/jquery.counterup.min.js"></script>
    <script src="adminnew/assets/js/imgfix.min.js"></script> 
    <script src="adminnew/assets/js/slick.js"></script> 
    <script src="adminnew/assets/js/lightbox.js"></script> 
    <script src="adminnew/assets/js/isotope.js"></script> 
    
    <!-- Global Init -->
    <script src="adminnew/assets/js/custom.js"></script>
